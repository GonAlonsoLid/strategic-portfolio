...
- [x] **MODEL-01**: IC (Information Coefficient) computed for each model: rank correlation between predicted join/leave probability and realized 21-day forward return
- [x] **MODEL-02**: IC decay curve by holding horizon (1d, 5d, 21d, 63d) for best model — shows how predictive power fades
- [x] **MODEL-03**: ICIR (IC / std(IC)) computed per model — industry-standard signal quality metric
- [x] **MODEL-04**: SHAP feature importance for best model — interpretable attribution of which signals drive predictions
...
|-------------|-------|--------|
| MODEL-01 | Phase 1 — Model Quality Analysis | Complete |
| MODEL-02 | Phase 1 — Model Quality Analysis | Complete |
| MODEL-03 | Phase 1 — Model Quality Analysis | Complete |
| MODEL-04 | Phase 1 — Model Quality Analysis | Complete |
